...
router.get('/createPost',userController.mustBeLoggedIn,postController.viewPostScreen)
router.post('/createPost',userController.mustBeLoggedIn,postController.create)
